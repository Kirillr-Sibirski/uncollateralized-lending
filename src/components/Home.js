      ...
      >
        ...
        >
          <div className="content-section" style={{color: "#82B7DC"}}>
            <h2>GET STARTED</h2>
            <p>Quickly get started by signing in with sismo to get the required information for generating
              the trust score and get an estimate of the eligible loan amount.
            </p>
          </div>
          ...
          <div className="content-section">
            {showLoan ? (
              <div style={{ flexDirection: 'column', display: 'flex', color: "#82B7DC", fontWeight: "bold" }}>
